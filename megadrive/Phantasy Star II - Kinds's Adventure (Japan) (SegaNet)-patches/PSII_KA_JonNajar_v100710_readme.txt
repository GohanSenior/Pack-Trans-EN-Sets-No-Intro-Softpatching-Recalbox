...
070607 Initial release
070805 A few script corrections, thanks to Bernd
081213 Script rewritten, corrections based on CD version, code updated
100710 Minor graphics fix, additional editing/corrections/improvements
...
"Phantasy Star II: Kinds's Adventure". It sports a variable-width font engine
with kerning and, as usual, it is a "dual-language" patch, meaning that it
supports both Japanese and English, depending on the country code of your
machine.
