...
"Phantasy Star II: Eusis's Adventure" (also spelled Yushis and Yousis).
...
depending on the country code of your machine.
...
Q: Why do you call the game "Eusis's Adventure" instead of "Yushis/Yousis"?

A: That is the spelling used by the Mega CD version of the game, which was
   produced later, has fewer bugs, and is generally more reliable. The older
   Sega Net version isn't even internally consistent with its spellings.

   In case you were wondering, graphics from the CD version were patched in
   to make the title screen and logo read "Eusis".
